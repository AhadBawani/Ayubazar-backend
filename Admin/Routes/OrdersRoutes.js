...
const { GET_ALL_ORDERS, ORDER_READY_FOR_DELIVER, DELETE_ORDER, GET_CANCEL_REQUEST_ORDERS, GET_ON_THE_WAY_ORDERS, ACCEPT_CANCEL_ORDER, REJECT_CANCEL_ORDER, ORDER_DELIVERED, GET_ORDER_DETAIL_IN_EXCEL, ORDER_EXCEL_DETAILS, GET_MONTHLY_REPORT, GET_DELETED_ORDERS } = require('../Controllers/OrdersController');
...
router.get('/deleted-orders', authMiddleware, checkAdmin, GET_DELETED_ORDERS);
