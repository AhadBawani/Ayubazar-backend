...
const { ADD_PRODUCT, GET_ALL_PRODUCTS, GET_PRODUCT_BY_ID, ENABLE_PRODUCT,
     ...
     BEST_SELLING_PRODUCT, GET_BEST_SALING_PRODUCTS,
     TOGGLE_COD_AVAILABLE, GET_LATEST_PRODUCTS, GET_NARAYANI_PRODUCTS, DELETE_PRODUCT } = require('../Controllers/ProductsController');
...
router.get('/get-narayani-products', GET_NARAYANI_PRODUCTS);
router.get('/best-selling-products', GET_BEST_SALING_PRODUCTS);
router.get('/latest-products', GET_LATEST_PRODUCTS);
...
router.post('/product-cod-available/:productId', authMiddleware, checkAdmin, TOGGLE_COD_AVAILABLE);
router.delete('/:productId', authMiddleware, checkAdmin, DELETE_PRODUCT);
